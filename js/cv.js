        ...
        function generateSectionHTML(title, content) {
            ...
            $.each(content, function (index, item) {
                if (item.hasOwnProperty("label")) {
                    ...
                    sectionHTML += '<p style="';
                    var paragraphStyle = item.hasOwnProperty("style") ? item.style : {};
                    for (var property in paragraphStyle) {
                        sectionHTML += property + ':' + paragraphStyle[property] + ';';
                    }
                    sectionHTML += '">' + item.phrase + '</p>';
                    nrPhrases += 1;
